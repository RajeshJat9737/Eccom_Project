import 'package:ecomm_class/data/remote/helper/api_helper.dart';
import 'package:ecomm_class/domain/constants/app_urls.dart';
    ...
    on<AddToCartEvent >((event, emit)async{
      emit(CartLoadingState());
       try{
          ...
          dynamic mData = await apiHelper.postApi(url: AppUrls.add_to_cart_url,mBodyPar:{
